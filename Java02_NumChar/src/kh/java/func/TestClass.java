...
public class TestClass {
	public void test1() {  //자료형 4가지로 표현한다.
	...
	public void test2() {
		...
		System.out.println(1.0+1.0); // -> 2.0 / 2.0
		System.out.println('1'+'1'); // -> 추측값 11 / 실행결과 98  
		System.out.println("1"+"1"); // -> 추측값 11 / 실행결과 11
	...
	public void test3() {
		...
		//만약 서로 다른 자료형을 연산하는 경우 -> 범위가 큰 자료형으로 변환해서 한번에 연산 
		//정수 + 실수 => 실수 + 실수 => 연산
		//1+1.1 -> 1.0+1.1 -> 2.1
